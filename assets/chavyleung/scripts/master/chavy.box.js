...
function getSystemCfgs() {
  ...
  return {
    ...
    envs: [
      { id: 'Surge', icons: ['https://cdn.podkit.cn/assets/Orz-3/mini/none/surge.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/surge.png'] },
      { id: 'QuanX', icons: ['https://cdn.podkit.cn/assets/Orz-3/mini/none/quanX.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/quantumultx.png'] },
      { id: 'Loon', icons: ['https://cdn.podkit.cn/assets/Orz-3/mini/none/loon.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/loon.png'] },
      { id: 'Shadowrocket', icons: ['https://cdn.podkit.cn/assets/Orz-3/mini/master/Alpha/shadowrocket.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/shadowrocket.png'] },
      { id: 'Stash', icons: ['https://cdn.podkit.cn/assets/Orz-3/mini/master/Alpha/stash.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/stash.png'] }
    ],
    ...
    orz3: { id: 'Orz-3', icon: 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/Orz-3.png', repo: 'https://github.com/Orz-3/' },
    boxjs: { id: 'BoxJs', show: false, icon: 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/box.png', icons: ['https://cdn.podkit.cn/assets/Orz-3/mini/master/Alpha/box.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/box.png'], repo: 'https://github.com/chavyleung/scripts' },
    defaultIcons: ['https://cdn.podkit.cn/assets/Orz-3/mini/master/Alpha/appstore.png', 'https://cdn.podkit.cn/assets/Orz-3/mini/master/Color/appstore.png']
  }
}
  ...
  const sysapps = [
    {
      ...
      scripts: [
        {
          name: "抹掉：所有缓存",
          script: "https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/scripts/boxjs.revert.caches.js"
        },
        {
          name: "抹掉：收藏应用",
          script: "https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/scripts/boxjs.revert.usercfgs.favapps.js"
        },
        {
          name: "抹掉：用户偏好",
          script: "https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/scripts/boxjs.revert.usercfgs.js"
        },
        {
          name: "抹掉：所有会话",
          script: "https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/scripts/boxjs.revert.usercfgs.sessions.js"
        },
        {
          name: "抹掉：所有备份",
          script: "https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/scripts/boxjs.revert.baks.js"
        },
        {
          name: "抹掉：BoxJs (注意备份)",
          script: "https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/scripts/boxjs.revert.boxjs.js"
        }
      ],
      author: '@chavyleung',
      repo: 'https://cdn.podkit.cn/assets/chavyleung/scripts/blob/master/box/switcher/box.switcher.js',
      icons: [
        'https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/icons/BoxSetting.mini.png',
        'https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/icons/BoxSetting.png'
      ]
    },
    {
      id: 'BoxSwitcher',
      ...
      repo: 'https://cdn.podkit.cn/assets/chavyleung/scripts/blob/master/box/switcher/box.switcher.js',
      icons: [
        'https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/icons/BoxSwitcher.mini.png',
        'https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/icons/BoxSwitcher.png'
      ],
      script: 'https://cdn.podkit.cn/assets/chavyleung/scripts/master/box/switcher/box.switcher.js'
    },
    {
      id: "BoxGist",
      name: "Gist备份",
      ...
      icons: [
        "https://cdn.podkit.cn/assets/Former-Years/icon/master/github-bf.png",
        "https://cdn.podkit.cn/assets/Former-Years/icon/master/github-bf.png"
      ],
      descs_html: [
        "<h2>Token的获取方式</h2>",
      ...
      scripts: [
        {
          name: "备份 Gist",
          script: "https://cdn.podkit.cn/assets/dompling/Script/master/gist/backup.js"
        },
        {
          name: "从 Gist 恢复",
          script: "https://cdn.podkit.cn/assets/dompling/Script/master/gist/restore.js"
        },
        {
          name: "更新历史版本",
          script: "https://cdn.podkit.cn/assets/dompling/Script/master/gist/commit.js"
        }
      ],
      settings: [
        {
